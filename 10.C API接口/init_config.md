...
`Py_RunMain()` 和 [`Py_Main()`](veryhigh.md#c.Py_Main "Py_Main") 将修改 [`sys.path`](3.标准库/sys.md#sys.path "sys.path"):

  * 如果 `run_filename` 已设置并且是一个包含 `__main__.py` 脚本的目录，则会将 `run_filename` 添加到 [`sys.path`](3.标准库/sys.md#sys.path "sys.path") 的开头。

  * 如果 `isolated` 为零：

    * 如果设置了 `run_module`，则将当前目录添加到 [`sys.path`](3.标准库/sys.md#sys.path "sys.path") 的开头。 如果无法读取当前目录则不执行任何操作。

    * 如果设置了 `run_filename`，则将文件名的目录添加到 [`sys.path`](3.标准库/sys.md#sys.path "sys.path") 的开头。

    * 在其他情况下，则将一个空字符串添加到 [`sys.path`](3.标准库/sys.md#sys.path "sys.path") 的开头。

如果 `site_import` 为非零值，则 [`sys.path`](3.标准库/sys.md#sys.path "sys.path") 可通过 [`site`](site.md#module-site "site: Module responsible for site-specific configuration.") 模块修改。 如果 `user_site_directory` 为非零值且用户的 site-package 目录存在，则 [`site`](site.md#module-site "site: Module responsible for site-specific configuration.") 模块会将用户的 site-package 目录附加到 [`sys.path`](3.标准库/sys.md#sys.path "sys.path")。
