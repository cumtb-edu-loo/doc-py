...
对Python 语言核心进行的小改动：
  ...
  * Frame objects now have a [`clear()`](datamodel.md#frame.clear "frame.clear") method that clears all references to local variables from the frame. (Contributed by Antoine Pitrou in [bpo-17934](https://bugs.python.org/issue?@action=redirect&bpo=17934).)
  ...
  * [`__length_hint__()`](datamodel.md#object.__length_hint__ "object.__length_hint__") is now part of the formal language specification (see [**PEP 424**](https://peps.python.org/pep-0424/)). (Contributed by Armin Ronacher in [bpo-16148](https://bugs.python.org/issue?@action=redirect&bpo=16148).)
