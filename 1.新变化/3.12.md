...
请注意 [`PyType_FromMetaclass()`](type.md#c.PyType_FromMetaclass "PyType_FromMetaclass") (在 Python 3.12 中新增) 已禁止创建具有重载了 `tp_new` (在 Python 中为 [`__new__()`](3.%20数据模型.md#object.__new__ "object.__new__") ) 的元类的类。
