...
请参阅 [文本编码格式](../library/io.md#io-text-encoding) 了解更多信息。
...
在 [`fileinput.input()`](../library/fileinput.md#fileinput.input "fileinput.input") 和 [`fileinput.FileInput`](../library/fileinput.md#fileinput.FileInput "fileinput.FileInput") 中增加了 _encoding_ 和 _errors_ 形参。 （由 Inada Naoki 在 [bpo-43712](https://bugs.python.org/issue?@action=redirect&bpo=43712) 中贡献。）
...
（由 Jelle Zijlstra 在 [gh-87889](https://github.com/python/cpython/issues/87889) 中贡献。）
  ...
  * 以下 [`ssl`](../library/ssl.md#module-ssl "ssl: TLS/SSL wrapper for socket objects") 特性自 Python 3.6, Python 3.7 或 OpenSSL 1.1.0 起已被弃用并将在 3.11 中移除:
    ...
    * [`OP_NO_SSLv2`](../library/ssl.md#ssl.OP_NO_SSLv2 "ssl.OP_NO_SSLv2"), [`OP_NO_SSLv3`](../library/ssl.md#ssl.OP_NO_SSLv3 "ssl.OP_NO_SSLv3"), [`OP_NO_TLSv1`](../library/ssl.md#ssl.OP_NO_TLSv1 "ssl.OP_NO_TLSv1"), [`OP_NO_TLSv1_1`](../library/ssl.md#ssl.OP_NO_TLSv1_1 "ssl.OP_NO_TLSv1_1"), [`OP_NO_TLSv1_2`](../library/ssl.md#ssl.OP_NO_TLSv1_2 "ssl.OP_NO_TLSv1_2") 及 [`OP_NO_TLSv1_3`](../library/ssl.md#ssl.OP_NO_TLSv1_3 "ssl.OP_NO_TLSv1_3") 会被 `sslSSLContext.minimum_version` 和 `sslSSLContext.maximum_version` 代替。

    * `PROTOCOL_SSLv2`, [`PROTOCOL_SSLv3`](../library/ssl.md#ssl.PROTOCOL_SSLv3 "ssl.PROTOCOL_SSLv3"), [`PROTOCOL_SSLv23`](../library/ssl.md#ssl.PROTOCOL_SSLv23 "ssl.PROTOCOL_SSLv23"), [`PROTOCOL_TLSv1`](../library/ssl.md#ssl.PROTOCOL_TLSv1 "ssl.PROTOCOL_TLSv1"), [`PROTOCOL_TLSv1_1`](../library/ssl.md#ssl.PROTOCOL_TLSv1_1 "ssl.PROTOCOL_TLSv1_1"), [`PROTOCOL_TLSv1_2`](../library/ssl.md#ssl.PROTOCOL_TLSv1_2 "ssl.PROTOCOL_TLSv1_2") 和 [`PROTOCOL_TLS`](../library/ssl.md#ssl.PROTOCOL_TLS "ssl.PROTOCOL_TLS") 已被弃用并应改用 [`PROTOCOL_TLS_CLIENT`](../library/ssl.md#ssl.PROTOCOL_TLS_CLIENT "ssl.PROTOCOL_TLS_CLIENT") 和 [`PROTOCOL_TLS_SERVER`](../library/ssl.md#ssl.PROTOCOL_TLS_SERVER "ssl.PROTOCOL_TLS_SERVER")

    * `wrap_socket()` 会被 [`ssl.SSLContext.wrap_socket()`](../library/ssl.md#ssl.SSLContext.wrap_socket "ssl.SSLContext.wrap_socket") 代替

    * `match_hostname()`

    * `RAND_pseudo_bytes()`, `RAND_egd()`

    * NPN 特性如 [`ssl.SSLSocket.selected_npn_protocol()`](../library/ssl.md#ssl.SSLSocket.selected_npn_protocol "ssl.SSLSocket.selected_npn_protocol") 和 [`ssl.SSLContext.set_npn_protocols()`](../library/ssl.md#ssl.SSLContext.set_npn_protocols "ssl.SSLContext.set_npn_protocols") 会被 ALPN 代替。

  * 线程调试 (`PYTHONTHREADDEBUG` 环境变量) 在 Python 3.10 中已被弃用并将在 Python 3.12 中移除。 此特性需要 [Python 的调试编译版](../using/configure.md#debug-build)。 （由 Victor Stinner 在 [bpo-44584](https://bugs.python.org/issue?@action=redirect&bpo=44584) 中贡献。）

  * 从 `typing.io` 和 `typing.re` 子模块导入现在将发出 [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning "DeprecationWarning")。 这些子模块将在未来的 Python 版本中被移除。 任何属于这些子模块的东西都应当改为直接从 [`typing`](../library/typing.md#module-typing "typing: Support for type hints \(see :pep:`484`\).") 导入。 （由 Sebastian Rittau 在 [bpo-38291](https://bugs.python.org/issue?@action=redirect&bpo=38291) 中贡献。）

## 移除¶

  * 移除了 [`complex`](../library/functions.md#complex "complex") 类的特殊方法 `__int__`, `__float__`, `__floordiv__`, `__mod__`, `__divmod__`, `__rfloordiv__`, `__rmod__` 和 `__rdivmod__`。 它们总是会引发 [`TypeError`](../library/exceptions.md#TypeError "TypeError")。 （由 Serhiy Storchaka 在 [bpo-41974](https://bugs.python.org/issue?@action=redirect&bpo=41974) 中贡献。）

  * `ParserBase.error()` 方法（来自私有且未记入文档的 `_markupbase` 模块）已被移除。 [`html.parser.HTMLParser`](../library/html.parser.md#html.parser.HTMLParser "html.parser.HTMLParser") 是 `ParserBase` 的唯一子类并且它的 `error()` 实现在 Python 3.5 中已被移除。 （由 Berker Peksag 在 [bpo-31844](https://bugs.python.org/issue?@action=redirect&bpo=31844) 中贡献。）
  ...
  * 从 [`collections`](../library/collections.md#module-collections "collections: Container datatypes") 模块中移除了已被弃用的 [容器抽象基类](../library/collections.abc.md#collections-abstract-base-classes) 的别名。 （由 Victor Stinner 在 [bpo-37324](https://bugs.python.org/issue?@action=redirect&bpo=37324) 中贡献。）

  * `loop` 形参已从大部分 [`asyncio`](../library/asyncio.md#module-asyncio "asyncio: Asynchronous I/O.") 的 [高层级 API](../library/asyncio-api-index.md) 中被移除，之前它们在 Python 3.8 中已被弃用。 这一改变的动机是多方面的:
...
### Python API 的变化¶
  ...
  * [`traceback`](../library/traceback.md#module-traceback "traceback: Print or retrieve a stack traceback.") 模块中的 [`format_exception()`](../library/traceback.md#traceback.format_exception "traceback.format_exception") 、 [`format_exception_only()`](../library/traceback.md#traceback.format_exception_only "traceback.format_exception_only") 和 [`print_exception()`](../library/traceback.md#traceback.print_exception "traceback.print_exception") 函数的 _etype_ 参数已更名为 _exc_ 。（由 Zackery Spytz 和 Matthias Bussonnier 贡献于 [bpo-26389](https://bugs.python.org/issue?@action=redirect&bpo=26389) ）

  * [`atexit`](../library/atexit.md#module-atexit "atexit: Register and execute cleanup functions.") ： 在 Python 退出时，若用 [`atexit.register()`](../library/atexit.md#atexit.register "atexit.register") 注册的回调失败，现在会记录其异常。以前，只有部分异常被记录，最后一个异常总是被静默忽略。（由 Victor Stinner 贡献于 [bpo-42639](https://bugs.python.org/issue?@action=redirect&bpo=42639) ）

  * 现在，泛型 [`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable "collections.abc.Callable") 的类型参数扁平化了，类似于 [`typing.Callable`](../library/typing.md#typing.Callable "typing.Callable") 目前的做法。这意味着 `collections.abc.Callable[[int, str], str]` 的 `__args__` 将为 `(int, str, str)`；而以前是 `([int, str], str)`。 通过 [`typing.get_args()`](../library/typing.md#typing.get_args "typing.get_args") 或 `__args__` 访问参数的代码需要考虑到这一变化。此外，为 [`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable "collections.abc.Callable") 给出无效参数可能会引发 [`TypeError`](../library/exceptions.md#TypeError "TypeError") ，而在 Python 3.9 中则可能会静默传入。（由 Ken Jin 贡献于 [bpo-42195](https://bugs.python.org/issue?@action=redirect&bpo=42195)）

  * 现在，如果给定的形参不是 16 位无符号整数， [`socket.htons()`](../library/socket.md#socket.htons "socket.htons") 和 [`socket.ntohs()`](../library/socket.md#socket.ntohs "socket.ntohs") 会引发 [`OverflowError`](../library/exceptions.md#OverflowError "OverflowError") 而非 [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning "DeprecationWarning")。 （由 Erlend E. Aasland 在 [bpo-42393](https://bugs.python.org/issue?@action=redirect&bpo=42393) 中贡献。）

  * The `loop` parameter has been removed from most of [`asyncio`](../library/asyncio.md#module-asyncio "asyncio: Asynchronous I/O.")'s [high-level API](../library/asyncio-api-index.md) following deprecation in Python 3.8.
...
如果 `foo()` 被特别设计成 _不_ 运行于当前线程的运行事件循环中（比如运行在另一个线程的事件循环中），请考虑使用 [`asyncio.run_coroutine_threadsafe()`](../library/asyncio-task.md#asyncio.run_coroutine_threadsafe "asyncio.run_coroutine_threadsafe") 来代替。

（由 Yurii Karabas, Andrew Svetlov, Yury Selivanov 和 Kyle Stanley 在 [bpo-42392](https://bugs.python.org/issue?@action=redirect&bpo=42392) 中贡献。）

  * 如果 _globals_ 字典中没有 `"__builtins__"` 键，那么 [`types.FunctionType`](../library/types.md#types.FunctionType "types.FunctionType") 构造器现在将继承当前值，而不是用 `{"None": None}`，这与 [`eval()`](../library/functions.md#eval "eval") 和 [`exec()`](../library/functions.md#exec "exec") 函数一致。 利用 `def function(...): ...` 定义一个 Python 函数则不受影响，globals 无法被这种语法覆盖：它也是继承了当前值。 （由 Victor Stinner 在 [bpo-42990](https://bugs.python.org/issue?@action=redirect&bpo=42990) 中贡献。）
...
现在应该用 [`Py_CompileString()`](../c-api/veryhigh.md#c.Py_CompileString "Py_CompileString") 将源代码直接编译为代码对象。然后可以用 [`PyEval_EvalCode()`](../c-api/veryhigh.md#c.PyEval_EvalCode "PyEval_EvalCode") 之类的东西来对其求值。
...
## 编译版的变化¶
  ...
  * [`sqlite3`](../library/sqlite3.md#module-sqlite3 "sqlite3: A DB-API 2.0 implementation using SQLite 3.x.") 需要 SQLite 3.7.15 以上版本。（由 Sergey Fedoseev 和 Erlend E. Aasland 贡献于 [bpo-40744](https://bugs.python.org/issue?@action=redirect&bpo=40744) 和 [bpo-40810](https://bugs.python.org/issue?@action=redirect&bpo=40810) ）

  * 现在， [`atexit`](../library/atexit.md#module-atexit "atexit: Register and execute cleanup functions.") 模块必须编译为内置模块。（由 Victor Stinner 贡献于 [bpo-42639](https://bugs.python.org/issue?@action=redirect&bpo=42639) ）

  * 在 `configure` 脚本中加入 [`--disable-test-modules`](../using/configure.md#cmdoption-disable-test-modules) 选项：不编译也不安装 test 模块。（由 Xavier de Gaye、Thomas Petazzoni 和 Peixing Xin 贡献于 [bpo-27640](https://bugs.python.org/issue?@action=redirect&bpo=27640)）

  * 在 `./configure` 脚本中加入 [`--with-wheel-pkg-dir=PATH 选项`](../using/configure.md#cmdoption-with-wheel-pkg-dir)。如果指定了该选项， [`ensurepip`](../library/ensurepip.md#module-ensurepip "ensurepip: Bootstrapping the "pip" installer into an existing Python installation or virtual environment.") 模块会在该目录下查找 `setuptools` 和 `pip` 包：如果两者都存在，就会使用这些包，而不是surepip 绑定的包。
...
（由 Victor Stinner 贡献于 [bpo-42856](https://bugs.python.org/issue?@action=redirect&bpo=42856)）
  ...
  * 增加了新的 [`configure --without-static-libpython 选项`](../using/configure.md#cmdoption-without-static-libpython) ，用于标明不编译 `libpythonMAJOR.MINOR.a` 静态库并且不安装 `python.o` 对象文件。
...
（由 Victor Stinner 在 [bpo-43103](https://bugs.python.org/issue?@action=redirect&bpo=43103) 中贡献。）
  ...
  * 为 `configure` 脚本加入 [`--with-openssl-rpath`](../using/configure.md#cmdoption-with-openssl-rpath) 选项。该选项简化了用定制版本 OpenSSL 编译 Python 的过程，例如 `./configure --with-openssl=/path/to/openssl --with-openssl-rpath=auto`。（由 Christian Heimes 贡献于 [bpo-43466](https://bugs.python.org/issue?@action=redirect&bpo=43466) ）

## C API 的变化¶

### PEP 652：稳定版 ABI 的维护¶

现在，用于扩展模块或嵌入 Python 的稳定版 ABI （应用程序二进制接口）已有显式的定义。 [C API 的稳定性](../c-api/stable.md#stable) 描述了 C API 和 ABI 稳定性保证和稳定版 ABI 的最佳实践。
...
### 新的特性¶
  ...
  * 现在 [`PyNumber_Index()`](../c-api/number.md#c.PyNumber_Index "PyNumber_Index") 的结果一定是 [`int`](../library/functions.md#int "int") 类型。此前可能是 `int` 的子类实例。（由 Serhiy Storchaka 贡献于 [bpo-40792](https://bugs.python.org/issue?@action=redirect&bpo=40792) ）

  * Add a new [`orig_argv`](../c-api/init_config.md#c.PyConfig.orig_argv "PyConfig.orig_argv") member to the [`PyConfig`](../c-api/init_config.md#c.PyConfig "PyConfig") structure: the list of the original command line arguments passed to the Python executable. (Contributed by Victor Stinner in [bpo-23427](https://bugs.python.org/issue?@action=redirect&bpo=23427).)

  * 加入宏 [`PyDateTime_DATE_GET_TZINFO()`](../c-api/datetime.md#c.PyDateTime_DATE_GET_TZINFO "PyDateTime_DATE_GET_TZINFO") 和 [`PyDateTime_TIME_GET_TZINFO()`](../c-api/datetime.md#c.PyDateTime_TIME_GET_TZINFO "PyDateTime_TIME_GET_TZINFO") ，用于访问 [`datetime.datetime`](../library/datetime.md#datetime.datetime "datetime.datetime") 和 [`datetime.time`](../library/datetime.md#datetime.time "datetime.time") 对象的 `tzinfo` 属性。 （由 Zackery Spytz 贡献于 [bpo-30155](https://bugs.python.org/issue?@action=redirect&bpo=30155) ）

  * 加入 [`PyCodec_Unregister()`](../c-api/codec.md#c.PyCodec_Unregister "PyCodec_Unregister") 函数，用于注销编解码器检索函数。（由 Hai Shi 贡献于 [bpo-41842](https://bugs.python.org/issue?@action=redirect&bpo=41842) ）

  * 加入 [`PyIter_Send()`](../c-api/iter.md#c.PyIter_Send "PyIter_Send") 函数，可不触发 `StopIteration` 异常地向迭代器发送数据。（由 Vladimir Matveev 贡献于 [bpo-41756](https://bugs.python.org/issue?@action=redirect&bpo=41756) ）

  * 受限 C API 中加入了 [`PyUnicode_AsUTF8AndSize()`](../c-api/unicode.md#c.PyUnicode_AsUTF8AndSize "PyUnicode_AsUTF8AndSize") 。（由 Alex Gaynor 贡献于 [bpo-41784](https://bugs.python.org/issue?@action=redirect&bpo=41784) ）

  * 加入 [`PyModule_AddObjectRef()`](../c-api/module.md#c.PyModule_AddObjectRef "PyModule_AddObjectRef") 函数：类似于 [`PyModule_AddObject()`](../c-api/module.md#c.PyModule_AddObject "PyModule_AddObject") 但在成功后不会偷取参数对象的引用计数。（由 Victor Stinner 贡献于 [bpo-1635741](https://bugs.python.org/issue?@action=redirect&bpo=1635741) ）

  * 加入 [`Py_NewRef()`](../c-api/refcounting.md#c.Py_NewRef "Py_NewRef") 和 [`Py_XNewRef()`](../c-api/refcounting.md#c.Py_XNewRef "Py_XNewRef") 函数，用于递增指定对象的引用计数并返回该对象。（由 Victor Stinner 贡献于 [bpo-42262](https://bugs.python.org/issue?@action=redirect&bpo=42262) ）

  * 现在， [`PyType_FromSpecWithBases()`](../c-api/type.md#c.PyType_FromSpecWithBases "PyType_FromSpecWithBases") 和 [`PyType_FromModuleAndSpec()`](../c-api/type.md#c.PyType_FromModuleAndSpec "PyType_FromModuleAndSpec") 函数可接受一个类作为 _bases_ 参数。（由 Serhiy Storchaka 贡献于 [bpo-42423](https://bugs.python.org/issue?@action=redirect&bpo=42423) ）

  * [`PyType_FromModuleAndSpec()`](../c-api/type.md#c.PyType_FromModuleAndSpec "PyType_FromModuleAndSpec") 函数现在接受 NULL `tp_doc` 槽位。 （由 Hai Shi 在 [bpo-41832](https://bugs.python.org/issue?@action=redirect&bpo=41832) 中贡献。）

  * [`PyType_GetSlot()`](../c-api/type.md#c.PyType_GetSlot "PyType_GetSlot") 函数现在可以接受 [静态类型](../c-api/typeobj.md#static-types)。 （由 Hai Shi 和 Petr Viktorin 在 [bpo-41073](https://bugs.python.org/issue?@action=redirect&bpo=41073) 中贡献。）

  * 新增 [`PySet_CheckExact()`](../c-api/set.md#c.PySet_CheckExact "PySet_CheckExact") 函数到 C-API 用于检查一个对象是否是 [`set`](../library/stdtypes.md#set "set") 的实例但不是其子类型的实例。 （由 Pablo Galindo 在 [bpo-43277](https://bugs.python.org/issue?@action=redirect&bpo=43277) 中贡献。）

  * 增加了 [`PyErr_SetInterruptEx()`](../c-api/exceptions.md#c.PyErr_SetInterruptEx "PyErr_SetInterruptEx")，它允许传入一个信号序号用于进行模拟。 （由 Antoine Pitrou 在 [bpo-43356](https://bugs.python.org/issue?@action=redirect&bpo=43356) 中贡献。）

  * 现在，[Python 以调试模式编译](../using/configure.md#debug-build) 时也支持受限 C API 的使用了（需先定义 `Py_DEBUG` 宏）。在受限 C API 中，如果 Python 是以调试模式编译的，且 `Py_LIMITED_API` 宏以 Python 3.10 以上版本为目标，那么现在 [`Py_INCREF()`](../c-api/refcounting.md#c.Py_INCREF "Py_INCREF") 和 [`Py_DECREF()`](../c-api/refcounting.md#c.Py_DECREF "Py_DECREF") 函数实现为非透明的函数调用，而非直接访问 [`PyObject.ob_refcnt`](../c-api/typeobj.md#c.PyObject.ob_refcnt "PyObject.ob_refcnt") 成员。在调试模式下支持受限 C API 成为可能，是因为自 Python 3.8 起 [`PyObject`](../c-api/structures.md#c.PyObject "PyObject") 结构体在发布模式和调试模式下是相同的（参见 [bpo-36465](https://bugs.python.org/issue?@action=redirect&bpo=36465) ）。

在 [`--with-trace-refs`](../using/configure.md#cmdoption-with-trace-refs) 特殊编译方式下（`Py_TRACE_REFS` 宏），仍不支持使用受限 C API 。（由 Victor Stinner 贡献于 [bpo-43688](https://bugs.python.org/issue?@action=redirect&bpo=43688) ）

  * 加入 [`Py_Is(x, y)`](../c-api/structures.md#c.Py_Is "Py_Is") 函数，用于测试 _x_ 对象是否是 _y_ 对象，等价于 Python 中的 `x is y`。还加入了 [`Py_IsNone()`](../c-api/structures.md#c.Py_IsNone "Py_IsNone") 、 [`Py_IsTrue()`](../c-api/structures.md#c.Py_IsTrue "Py_IsTrue") 、 [`Py_IsFalse()`](../c-api/structures.md#c.Py_IsFalse "Py_IsFalse") 函数，分别用于测试某对象是否为 `None` 单例、`True` 单例或 `False` 单例。（由 Victor Stinner 贡献于 [bpo-43753](https://bugs.python.org/issue?@action=redirect&bpo=43753) ）

  * 新增由 C 代码控制垃圾回收器的函数: [`PyGC_Enable()`](../c-api/gcsupport.md#c.PyGC_Enable "PyGC_Enable"), 、[`PyGC_Disable()`](../c-api/gcsupport.md#c.PyGC_Disable "PyGC_Disable") 、 [`PyGC_IsEnabled()`](../c-api/gcsupport.md#c.PyGC_IsEnabled "PyGC_IsEnabled")。这些函数允许从 C 代码激活、停止和查询垃圾回收器的状态，而不必导入 [`gc`](../library/gc.md#module-gc "gc: Interface to the cycle-detecting garbage collector.") 模块。

  * 新增了 [`Py_TPFLAGS_DISALLOW_INSTANTIATION`](../c-api/typeobj.md#c.Py_TPFLAGS_DISALLOW_INSTANTIATION "Py_TPFLAGS_DISALLOW_INSTANTIATION") 类型旗标用于禁止创建类型实例。 （由 Victor Stinner 在 [bpo-43916](https://bugs.python.org/issue?@action=redirect&bpo=43916) 中贡献。）.)

  * 新增了 [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE "Py_TPFLAGS_IMMUTABLETYPE") 类型旗标用于创建不可变类型对象：类型的属性不可被设置或删除。 （由 Victor Stinner 和 Erlend E. Aasland 在 [bpo-43908](https://bugs.python.org/issue?@action=redirect&bpo=43908) 中贡献。）

### 移植到 Python 3.10¶

  * 现在必须定义 `PY_SSIZE_T_CLEAN` 宏才能使用 [`PyArg_ParseTuple()`](../c-api/arg.md#c.PyArg_ParseTuple "PyArg_ParseTuple") 和 [`Py_BuildValue()`](../c-api/arg.md#c.Py_BuildValue "Py_BuildValue") 格式，这些格式会使用 `#`: `es#`, `et#`, `s#`, `u#`, `y#`, `z#`, `U#` 和 `Z#`。 参见 [解析参数并构建值变量](../c-api/arg.md#arg-parsing) 和 [**PEP 353**](https://peps.python.org/pep-0353/)。 （由 Victor Stinner 在 [bpo-40943](https://bugs.python.org/issue?@action=redirect&bpo=40943) 中贡献。）

  * 由于 [`Py_REFCNT()`](../c-api/refcounting.md#c.Py_REFCNT "Py_REFCNT") 已改为内联静态函数，`Py_REFCNT(obj) = new_refcnt` 必须换成 `Py_SET_REFCNT(obj, new_refcnt)`: 参见 [`Py_SET_REFCNT()`](../c-api/refcounting.md#c.Py_SET_REFCNT "Py_SET_REFCNT") （自 Python 3.9 起提供）。为保持向下兼容，可用此宏：
...
（由 Victor Stinner 在 [bpo-39573](https://bugs.python.org/issue?@action=redirect&bpo=39573) 中贡献。）
  ...
  * 由于历史原因，曾经允许调用 [`PyDict_GetItem()`](../c-api/dict.md#c.PyDict_GetItem "PyDict_GetItem") 时不带 [GIL](../glossary.md#term-GIL) 。 现在则不行了。（由 Victor Stinner 贡献于 [bpo-40839](https://bugs.python.org/issue?@action=redirect&bpo=40839) ）

  * 现在， `PyUnicode_FromUnicode(NULL, size)` 和 `PyUnicode_FromStringAndSize(NULL, size)` 会引发 `DeprecationWarning`。 请利用 [`PyUnicode_New()`](../c-api/unicode.md#c.PyUnicode_New "PyUnicode_New") 获得不带初始数据的 Unicode 对象。（由 Inada Naoki 贡献于 [bpo-36346](https://bugs.python.org/issue?@action=redirect&bpo=36346) ）
  ...
  * 现在 [`Py_GetPath()`](../c-api/init.md#c.Py_GetPath "Py_GetPath"), [`Py_GetPrefix()`](../c-api/init.md#c.Py_GetPrefix "Py_GetPrefix"), [`Py_GetExecPrefix()`](../c-api/init.md#c.Py_GetExecPrefix "Py_GetExecPrefix"), [`Py_GetProgramFullPath()`](../c-api/init.md#c.Py_GetProgramFullPath "Py_GetProgramFullPath"), [`Py_GetPythonHome()`](../c-api/init.md#c.Py_GetPythonHome "Py_GetPythonHome") 和 [`Py_GetProgramName()`](../c-api/init.md#c.Py_GetProgramName "Py_GetProgramName") 函数如果在 [`Py_Initialize()`](../c-api/init.md#c.Py_Initialize "Py_Initialize") 之前（在 Python 被初始化之前）被调用将返回 `NULL`。 请使用新的 [Python初始化配置](../c-api/init_config.md#init-config) API 来获取 [Python 路径配置](../c-api/init_config.md#init-path-config)。 （由 Victor Stinner 在 [bpo-42260](https://bugs.python.org/issue?@action=redirect&bpo=42260) 中贡献。）

  * 宏 [`PyList_SET_ITEM()`](../c-api/list.md#c.PyList_SET_ITEM "PyList_SET_ITEM") 、 [`PyTuple_SET_ITEM()`](../c-api/tuple.md#c.PyTuple_SET_ITEM "PyTuple_SET_ITEM") 和 [`PyCell_SET()`](../c-api/cell.md#c.PyCell_SET "PyCell_SET") 不可再用作左值或右值。例如，现在 `x = PyList_SET_ITEM(a, b, c)` 和 `PyList_SET_ITEM(a, b, c) = x` 会失败并提示编译器错误。 这可以防止 `if (PyList_SET_ITEM (a, b, c) < 0) ...` 之类的检测发生问题。（由 Zackery Spytz 和 Victor Stinner 贡献于 [bpo-30459](https://bugs.python.org/issue?@action=redirect&bpo=30459) ）

  * 非受限 API 文件 `odictobject.h`, `parser_interface.h`, `picklebufobject.h`, `pyarena.h`, `pyctype.h`, `pydebug.h`, `pyfpe.h` 和 `pytime.h` 已被移至 `Include/cpython` 目录。 这些文件不可被直接包括，因为它们已经在 `Python.h` 中被包括了；参见 [包含文件](../c-api/intro.md#api-includes)。 如果它们已被直接包括，请考虑改为包括 `Python.h`。 （由 Nicholas Sim 在 [bpo-35134](https://bugs.python.org/issue?@action=redirect&bpo=35134) 中贡献。）

  * 请使用 [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE "Py_TPFLAGS_IMMUTABLETYPE") 类型旗标来创建不可变类型对象。 请勿依赖于 [`Py_TPFLAGS_HEAPTYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_HEAPTYPE "Py_TPFLAGS_HEAPTYPE") 来确定类型对象是否可变；应改为检查是否设置了 [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE "Py_TPFLAGS_IMMUTABLETYPE")。 （由 Victor Stinner 和 Erlend E. Aasland 在 [bpo-43908](https://bugs.python.org/issue?@action=redirect&bpo=43908) 中贡献。）
...
### 弃用¶
  ...
  * 现在 `PyUnicode_InternImmortal()` 函数已被弃用，并将在 Python 3.12 中移除：请改用 [`PyUnicode_InternInPlace()`](../c-api/unicode.md#c.PyUnicode_InternInPlace "PyUnicode_InternInPlace")。（由 Victor Stinner 贡献于 [bpo-41692](https://bugs.python.org/issue?@action=redirect&bpo=41692) ）
...
>     * `Py_UNICODE_strchr`, `Py_UNICODE_strrchr`: 使用 [`PyUnicode_FindChar()`](../c-api/unicode.md#c.PyUnicode_FindChar "PyUnicode_FindChar")
  ...
  * 移除了 `PyLong_FromUnicode()`。 请迁移到 [`PyLong_FromUnicodeObject()`](../c-api/long.md#c.PyLong_FromUnicodeObject "PyLong_FromUnicodeObject")。 （由 Inada Naoki 在 [bpo-41103](https://bugs.python.org/issue?@action=redirect&bpo=41103) 中贡献。）

  * 移除了 `PyUnicode_AsUnicodeCopy()`。 请使用 [`PyUnicode_AsUCS4Copy()`](../c-api/unicode.md#c.PyUnicode_AsUCS4Copy "PyUnicode_AsUCS4Copy") 或 [`PyUnicode_AsWideCharString()`](../c-api/unicode.md#c.PyUnicode_AsWideCharString "PyUnicode_AsWideCharString") （由 Inada Naoki 在 [bpo-41103](https://bugs.python.org/issue?@action=redirect&bpo=41103) 中贡献。）

  * 移除了 `_Py_CheckRecursionLimit` 变量：它已被 [`PyInterpreterState`](../c-api/init.md#c.PyInterpreterState "PyInterpreterState") 结构体的 `ceval.recursion_limit` 所取代。 （由 Victor Stinner 在 [bpo-41834](https://bugs.python.org/issue?@action=redirect&bpo=41834) 中贡献。）

  * 移除了未记入文档的宏 `Py_ALLOW_RECURSION` 和 `Py_END_ALLOW_RECURSION` 以及 [`PyInterpreterState`](../c-api/init.md#c.PyInterpreterState "PyInterpreterState") 结构体的 `recursion_critical` 字段。 （由 Serhiy Storchaka 在 [bpo-41936](https://bugs.python.org/issue?@action=redirect&bpo=41936) 中贡献。）

  * 移除了未记入文档的 `PyOS_InitInterrupts()` 函数。Python 初始化时已隐式安装了信号处理 handler：参见 [`PyConfig.install_signal_handlers`](../c-api/init_config.md#c.PyConfig.install_signal_handlers "PyConfig.install_signal_handlers")。（由 Victor Stinner 贡献于 [bpo-41713](https://bugs.python.org/issue?@action=redirect&bpo=41713) ）
...
请改用 Python [`symtable`](../library/symtable.md#module-symtable "symtable: Interface to the compiler's internal symbol tables.") 模块。 （由 Victor Stinner 在 [bpo-43244](https://bugs.python.org/issue?@action=redirect&bpo=43244) 中贡献。）

  * [`PyOS_ReadlineFunctionPointer()`](../c-api/veryhigh.md#c.PyOS_ReadlineFunctionPointer "PyOS_ReadlineFunctionPointer") 已从受限 C API 头文件和 `python3.dll` 中移除，此 dll 为 Windows 中的稳定版 ABI 库。由于该函数可接受一个 `FILE*` 参数，所以无法保证其 ABI 稳定性。（由 Petr Viktorin 贡献于 [bpo-43868](https://bugs.python.org/issue?@action=redirect&bpo=43868) ）

  * 移除了 `ast.h`, `asdl.h` 和 `Python-ast.h` 头文件。 这些函数未入文档且不属于受限 C API。这些头文件中定义的大多数名称都不带 `Py` 前缀，因此可能会造成命名冲突。比如 `Python-ast.h` 定义了一个 `Yield` 宏，就会与另一个Windows `<winbase.h>` 头文件中的 `Yield` 冲突。请改用 Python [`ast`](../library/ast.md#module-ast "ast: Abstract Syntax Tree classes and manipulation.") 模块。（由 Victor Stinner 贡献于 [bpo-43244](https://bugs.python.org/issue?@action=redirect&bpo=43244) ）
