...
在 3.3 版本发生变更: 模块中有几个函数用于触发 [`WindowsError`](3.标准库/exceptions.md#WindowsError "WindowsError")，此异常现在是 [`OSError`](3.标准库/exceptions.md#OSError "OSError") 的别名。
...
引发一个 [审计事件](3.标准库/sys.md#auditing) `winreg.ExpandEnvironmentStrings`，附带参数 `str`。
