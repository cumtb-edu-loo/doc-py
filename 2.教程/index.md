...
标准库与模块的内容详见 [Python 标准库](3.标准库/index.md#library-index)。[Python 语言参考手册](4.语言参考/index.md#reference-index) 是更正规的语言定义。如要编写 C 或 C++ 扩展请参考 [扩展和嵌入 Python 解释器](9.拓展和嵌入/index.md#extending-index) 和 [Python/C API 参考手册](10.C%20API接口/index.md#c-api-index)。此外，深入讲解 Python 的书籍也有很多。
