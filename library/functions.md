...
在 3.9 版本发生变更: 当使用了命令行参数 [`-E`](../using/cmdline.md#cmdoption-E) 或 [`-I`](../using/cmdline.md#cmdoption-I) 时，环境变量 [`PYTHONCASEOK`](../using/cmdline.md#envvar-PYTHONCASEOK) 现在将被忽略。
