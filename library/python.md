...
本章里描述的模块提供了和Python解释器及其环境交互相关的广泛服务。以下是综述：
  ...
  * [`sys` \--- 系统相关的形参和函数](sys.md)
    * [`abiflags`](sys.md#sys.abiflags)
    * [`addaudithook()`](sys.md#sys.addaudithook)
    * [`argv`](sys.md#sys.argv)
    * [`audit()`](sys.md#sys.audit)
    * [`base_exec_prefix`](sys.md#sys.base_exec_prefix)
    * [`base_prefix`](sys.md#sys.base_prefix)
    * [`byteorder`](sys.md#sys.byteorder)
    * [`builtin_module_names`](sys.md#sys.builtin_module_names)
    * [`call_tracing()`](sys.md#sys.call_tracing)
    * [`copyright`](sys.md#sys.copyright)
    * [`_clear_type_cache()`](sys.md#sys._clear_type_cache)
    * [`_current_frames()`](sys.md#sys._current_frames)
    * [`_current_exceptions()`](sys.md#sys._current_exceptions)
    * [`breakpointhook()`](sys.md#sys.breakpointhook)
    * [`_debugmallocstats()`](sys.md#sys._debugmallocstats)
    * [`dllhandle`](sys.md#sys.dllhandle)
    * [`displayhook()`](sys.md#sys.displayhook)
    * [`dont_write_bytecode`](sys.md#sys.dont_write_bytecode)
    * [`_emscripten_info`](sys.md#sys._emscripten_info)
      * [`_emscripten_info.emscripten_version`](sys.md#sys._emscripten_info.emscripten_version)
      * [`_emscripten_info.runtime`](sys.md#sys._emscripten_info.runtime)
      * [`_emscripten_info.pthreads`](sys.md#sys._emscripten_info.pthreads)
      * [`_emscripten_info.shared_memory`](sys.md#sys._emscripten_info.shared_memory)
    * [`pycache_prefix`](sys.md#sys.pycache_prefix)
    * [`excepthook()`](sys.md#sys.excepthook)
    * [`__breakpointhook__`](sys.md#sys.__breakpointhook__)
    * [`__displayhook__`](sys.md#sys.__displayhook__)
    * [`__excepthook__`](sys.md#sys.__excepthook__)
    * [`__unraisablehook__`](sys.md#sys.__unraisablehook__)
    * [`exception()`](sys.md#sys.exception)
    * [`exc_info()`](sys.md#sys.exc_info)
    * [`exec_prefix`](sys.md#sys.exec_prefix)
    * [`executable`](sys.md#sys.executable)
    * [`exit()`](sys.md#sys.exit)
    * [`flags`](sys.md#sys.flags)
      * [`flags.debug`](sys.md#sys.flags.debug)
      * [`flags.inspect`](sys.md#sys.flags.inspect)
      * [`flags.interactive`](sys.md#sys.flags.interactive)
      * [`flags.isolated`](sys.md#sys.flags.isolated)
      * [`flags.optimize`](sys.md#sys.flags.optimize)
      * [`flags.dont_write_bytecode`](sys.md#sys.flags.dont_write_bytecode)
      * [`flags.no_user_site`](sys.md#sys.flags.no_user_site)
      * [`flags.no_site`](sys.md#sys.flags.no_site)
      * [`flags.ignore_environment`](sys.md#sys.flags.ignore_environment)
      * [`flags.verbose`](sys.md#sys.flags.verbose)
      * [`flags.bytes_warning`](sys.md#sys.flags.bytes_warning)
      * [`flags.quiet`](sys.md#sys.flags.quiet)
      * [`flags.hash_randomization`](sys.md#sys.flags.hash_randomization)
      * [`flags.dev_mode`](sys.md#sys.flags.dev_mode)
      * [`flags.utf8_mode`](sys.md#sys.flags.utf8_mode)
      * [`flags.safe_path`](sys.md#sys.flags.safe_path)
      * [`flags.int_max_str_digits`](sys.md#sys.flags.int_max_str_digits)
      * [`flags.warn_default_encoding`](sys.md#sys.flags.warn_default_encoding)
    * [`float_info`](sys.md#sys.float_info)
      * [`float_info.epsilon`](sys.md#sys.float_info.epsilon)
      * [`float_info.dig`](sys.md#sys.float_info.dig)
      * [`float_info.mant_dig`](sys.md#sys.float_info.mant_dig)
      * [`float_info.max`](sys.md#sys.float_info.max)
      * [`float_info.max_exp`](sys.md#sys.float_info.max_exp)
      * [`float_info.max_10_exp`](sys.md#sys.float_info.max_10_exp)
      * [`float_info.min`](sys.md#sys.float_info.min)
      * [`float_info.min_exp`](sys.md#sys.float_info.min_exp)
      * [`float_info.min_10_exp`](sys.md#sys.float_info.min_10_exp)
      * [`float_info.radix`](sys.md#sys.float_info.radix)
      * [`float_info.rounds`](sys.md#sys.float_info.rounds)
    * [`float_repr_style`](sys.md#sys.float_repr_style)
    * [`getallocatedblocks()`](sys.md#sys.getallocatedblocks)
    * [`getunicodeinternedsize()`](sys.md#sys.getunicodeinternedsize)
    * [`getandroidapilevel()`](sys.md#sys.getandroidapilevel)
    * [`getdefaultencoding()`](sys.md#sys.getdefaultencoding)
    * [`getdlopenflags()`](sys.md#sys.getdlopenflags)
    * [`getfilesystemencoding()`](sys.md#sys.getfilesystemencoding)
    * [`getfilesystemencodeerrors()`](sys.md#sys.getfilesystemencodeerrors)
    * [`get_int_max_str_digits()`](sys.md#sys.get_int_max_str_digits)
    * [`getrefcount()`](sys.md#sys.getrefcount)
    * [`getrecursionlimit()`](sys.md#sys.getrecursionlimit)
    * [`getsizeof()`](sys.md#sys.getsizeof)
    * [`getswitchinterval()`](sys.md#sys.getswitchinterval)
    * [`_getframe()`](sys.md#sys._getframe)
    * [`_getframemodulename()`](sys.md#sys._getframemodulename)
    * [`getprofile()`](sys.md#sys.getprofile)
    * [`gettrace()`](sys.md#sys.gettrace)
    * [`getwindowsversion()`](sys.md#sys.getwindowsversion)
    * [`get_asyncgen_hooks()`](sys.md#sys.get_asyncgen_hooks)
    * [`get_coroutine_origin_tracking_depth()`](sys.md#sys.get_coroutine_origin_tracking_depth)
    * [`hash_info`](sys.md#sys.hash_info)
      * [`hash_info.width`](sys.md#sys.hash_info.width)
      * [`hash_info.modulus`](sys.md#sys.hash_info.modulus)
      * [`hash_info.inf`](sys.md#sys.hash_info.inf)
      * [`hash_info.nan`](sys.md#sys.hash_info.nan)
      * [`hash_info.imag`](sys.md#sys.hash_info.imag)
      * [`hash_info.algorithm`](sys.md#sys.hash_info.algorithm)
      * [`hash_info.hash_bits`](sys.md#sys.hash_info.hash_bits)
      * [`hash_info.seed_bits`](sys.md#sys.hash_info.seed_bits)
    * [`hexversion`](sys.md#sys.hexversion)
    * [`implementation`](sys.md#sys.implementation)
    * [`int_info`](sys.md#sys.int_info)
      * [`int_info.bits_per_digit`](sys.md#sys.int_info.bits_per_digit)
      * [`int_info.sizeof_digit`](sys.md#sys.int_info.sizeof_digit)
      * [`int_info.default_max_str_digits`](sys.md#sys.int_info.default_max_str_digits)
      * [`int_info.str_digits_check_threshold`](sys.md#sys.int_info.str_digits_check_threshold)
    * [`__interactivehook__`](sys.md#sys.__interactivehook__)
    * [`intern()`](sys.md#sys.intern)
    * [`is_finalizing()`](sys.md#sys.is_finalizing)
    * [`last_exc`](sys.md#sys.last_exc)
    * [`last_type`](sys.md#sys.last_type)
    * [`last_value`](sys.md#sys.last_value)
    * [`last_traceback`](sys.md#sys.last_traceback)
    * [`maxsize`](sys.md#sys.maxsize)
    * [`maxunicode`](sys.md#sys.maxunicode)
    * [`meta_path`](sys.md#sys.meta_path)
    * [`modules`](sys.md#sys.modules)
    * [`orig_argv`](sys.md#sys.orig_argv)
    * [`path`](sys.md#sys.path)
    * [`path_hooks`](sys.md#sys.path_hooks)
    * [`path_importer_cache`](sys.md#sys.path_importer_cache)
    * [`platform`](sys.md#sys.platform)
    * [`platlibdir`](sys.md#sys.platlibdir)
    * [`prefix`](sys.md#sys.prefix)
    * [`ps1`](sys.md#sys.ps1)
    * [`ps2`](sys.md#sys.ps2)
    * [`setdlopenflags()`](sys.md#sys.setdlopenflags)
    * [`set_int_max_str_digits()`](sys.md#sys.set_int_max_str_digits)
    * [`setprofile()`](sys.md#sys.setprofile)
    * [`setrecursionlimit()`](sys.md#sys.setrecursionlimit)
    * [`setswitchinterval()`](sys.md#sys.setswitchinterval)
    * [`settrace()`](sys.md#sys.settrace)
    * [`set_asyncgen_hooks()`](sys.md#sys.set_asyncgen_hooks)
    * [`set_coroutine_origin_tracking_depth()`](sys.md#sys.set_coroutine_origin_tracking_depth)
    * [`activate_stack_trampoline()`](sys.md#sys.activate_stack_trampoline)
    * [`deactivate_stack_trampoline()`](sys.md#sys.deactivate_stack_trampoline)
    * [`is_stack_trampoline_active()`](sys.md#sys.is_stack_trampoline_active)
    * [`_enablelegacywindowsfsencoding()`](sys.md#sys._enablelegacywindowsfsencoding)
    * [`stdin`](sys.md#sys.stdin)
    * [`stdout`](sys.md#sys.stdout)
    * [`stderr`](sys.md#sys.stderr)
    * [`__stdin__`](sys.md#sys.__stdin__)
    * [`__stdout__`](sys.md#sys.__stdout__)
    * [`__stderr__`](sys.md#sys.__stderr__)
    * [`stdlib_module_names`](sys.md#sys.stdlib_module_names)
    * [`thread_info`](sys.md#sys.thread_info)
      * [`thread_info.name`](sys.md#sys.thread_info.name)
      * [`thread_info.lock`](sys.md#sys.thread_info.lock)
      * [`thread_info.version`](sys.md#sys.thread_info.version)
    * [`tracebacklimit`](sys.md#sys.tracebacklimit)
    * [`unraisablehook()`](sys.md#sys.unraisablehook)
    * [`version`](sys.md#sys.version)
    * [`api_version`](sys.md#sys.api_version)
    * [`version_info`](sys.md#sys.version_info)
    * [`warnoptions`](sys.md#sys.warnoptions)
    * [`winver`](sys.md#sys.winver)
    * [`_xoptions`](sys.md#sys._xoptions)
