...
返回 _path_ 在文件系统中的表示形式。 如果该对象是一个 [`str`](../library/stdtypes.md#str "str") 或 [`bytes`](../library/stdtypes.md#bytes "bytes") 对象，则返回一个新的 [strong reference](../glossary.md#term-strong-reference)。 如果对象实现了 [`os.PathLike`](../library/os.md#os.PathLike "os.PathLike") 接口，则只要它是一个 [`str`](../library/stdtypes.md#str "str") 或 [`bytes`](../library/stdtypes.md#bytes "bytes") 对象就将返回 [`__fspath__()`](../library/os.md#os.PathLike.__fspath__ "os.PathLike.__fspath__")。 在其他情况下将引发 [`TypeError`](../library/exceptions.md#TypeError "TypeError") 并返回 `NULL`。
