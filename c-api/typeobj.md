...
Must return an [awaitable](../glossary.md#term-awaitable) object. See [`__anext__()`](../reference/datamodel.md#object.__anext__ "object.__anext__") for details. This slot may be set to `NULL`.
...
typedef [PyObject](structures.md#c.PyObject "PyObject") *(*allocfunc)([PyTypeObject](type.md#c.PyTypeObject "PyTypeObject") *cls, [Py_ssize_t](intro.md#c.Py_ssize_t "Py_ssize_t") nitems)¶  
